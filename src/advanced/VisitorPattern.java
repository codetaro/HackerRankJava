...
class ProductOfRedNodesVisitor extends TreeVis {
     ...
     * @implNote the product of zero values is equal to 1
     */
    public int getResult() {
        return (int) result;
    }
...
public class VisitorPattern {
    ...
    public static Tree solve() {
        //read the tree from STDIN and return its root as parent return value of this function
